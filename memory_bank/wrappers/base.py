...
class BaseLLMWrapper(ABC):
    ...
    def analyze_and_extract_knowledge(self, text: str) -> Dict:
        """
        Analyzes text to extract a structured knowledge graph containing
        atomic facts, entities, and relationships between them.
        
        The expected return format is a dictionary with three keys:
        - "facts": List[Dict[str, str]] -> [{"fact": "..."}, ...]
